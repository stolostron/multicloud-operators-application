...
PATH=/go/src/github.com/open-cluster-management/multicloud-operators-application/test_tmp/bin/kubebuilder/bin:${PATH}
export PATH
export KUBEBUILDER_ASSETS=/go/src/github.com/open-cluster-management/multicloud-operators-application/test_tmp/bin/kubebuilder/bin
